...
const report = {provider:'hyperframes',compiler_version:'0.3.0',source_ir:irPath,total_duration:totalDuration,fps:ir.canvas.fps,warnings,semantic_mappings:semanticMappings};
